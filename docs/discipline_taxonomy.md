...
audit:
  - property: multi_location_in_operation
    evidence:
      - "docs/intuit.md §5 Invocation — documents standalone + embedded modes across /innovate, /td-critique, /MVL+ pipeline-early"
      - "docs/intuit.md §10 Integration patterns — documents /innovate + /td-critique + /MVL+ integration points"
  - property: spec_quality_in_documentation
    evidence:
      - "docs/intuit.md §2 Core operation (3-step numbered process)"
      - "docs/intuit.md §8 Failure modes (6 inherited transform failures + 3 primitive-specific)"
      - "docs/intuit.md §7 Decline conditions (4 named → INSUFFICIENT_INTUITION)"
      - "docs/intuit.md §6 Output schema (11-13 fields + invocation trace)"
      - "docs/intuit.md §1 'What /intuit IS and IS NOT' — distinguishing definition vs 6 neighbors"
  - property: distinct_primitive_profile
    evidence: "docs/intuit.md implicit profile: Simulation + Intuition-similarity + Metacognition + Inhibition + Working Memory load-bearing; no Core discipline shares this combination"
  - property: always_available_infrastructure_in_use
    evidence:
      - "docs/intuit.md §10 — /innovate uses /intuit to seed Domain Transfer + Combination mechanisms"
      - "docs/intuit.md §10 — /td-critique uses /intuit in validator mode for prosecution/defense corpus grounding"
...
- `docs/intuit.md` — `/intuit` discipline spec
