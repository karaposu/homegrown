...
After `homegrown/protocols/loop_diagnose.md` has been used successfully on at least one real correction chain, MVL+ may add this explicit hook before `_branch.md` creation:
