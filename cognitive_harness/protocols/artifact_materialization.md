...
- after-use review of an artifact that has already been used. Use `cognitive_harness/protocols/outcome_review.md` for that.
...
- new standalone `bar/*.md` concept note;
...
- `follow_up_review_gate` must route to `cognitive_harness/protocols/outcome_review.md` after first meaningful use or downstream failure.
