> **Loading note.** This is a small controller for Navigation context intake. It chooses the correct warm-up path; detailed routines live under `cognitive_harness/navigation/warmup/`.
...
```text
cognitive_harness/navigation/warmup/
```
...
- **Duplicate authority:** this controller restates warm-up details. Correction: move detail to `cognitive_harness/navigation/warmup/`.
