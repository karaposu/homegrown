...
- the task is causal diagnosis; use `cognitive_harness/protocols/loop_diagnose.md`;
- the task is after-use judgment; use `cognitive_harness/protocols/outcome_review.md`;
- the task is turning a decision into files; use `cognitive_harness/protocols/artifact_materialization.md`.
...
- changed Navigation-owned files under `cognitive_harness/navigation/`;
- changed Navigation-relevant protocols or contracts under `cognitive_harness/protocols/` and `cognitive_harness/contracts/`;
...
- `cognitive_harness/navigation/SKILL.md`;
- `cognitive_harness/navigation/references/navigation.md`;
- `cognitive_harness/navigation/warmup/*.md`;
- `cognitive_harness/protocols/branch_inquiry.md`;
- `cognitive_harness/protocols/artifact_materialization.md`;
- `cognitive_harness/protocols/multi_resolution_navigation.md`;
- `cognitive_harness/protocols/navigation_context_intake.md`;
- `cognitive_harness/protocols/outcome_review.md`;
- `cognitive_harness/protocols/loop_diagnose.md`;
