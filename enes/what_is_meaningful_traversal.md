...
`enes/thinking_space_dynamics.md` introduces the idea of thinking space as the territory the loops traverse. Meaningful traversal is the verb form of that noun. If thinking space is the where, meaningful traversal is the *was-this-walk-worth-walking*.
