...
- **Codebase orientation:** read the top-level project structure and understand what lives in `homegrown/`, `devdocs/`, `enes/`, install scripts, and important runtime folders.
...
3. Read stable long-run concept docs in enes/ when relevant.
