...
- `homegrown/contracts/alignment_control.md`, which defines shared alignment vocabulary and record shape;
...
| `reflect` | Process quality of a completed loop is at issue | `homegrown/reflect/` |
| `outcome_review` | A finding, protocol, branch, or artifact has been used downstream | `homegrown/protocols/outcome_review.md` |
| `loop_diagnose` | Attribution is unclear and correction-chain evidence exists | `homegrown/protocols/loop_diagnose.md` + MVL+ |
| `navigation` | Several possible next moves should be enumerated | `homegrown/navigation/` |
| `branch` | A source-anchored child inquiry should be created | `homegrown/protocols/branch_inquiry.md` |
...
`homegrown/contracts/alignment_control.md` is the shared contract.
...
`enes/thinking_space_dynamics.md` defines quality-awareness timing:
