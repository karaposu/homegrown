...
- `enes/runtime_environment/folder_based.md` — the folder system inquiries live in (including the `_branch.md` template structure).
- `homegrown/protocols/branch_inquiry.md` — the `BRANCH_INQUIRY` protocol that creates child inquiries with their own `_branch.md`.
